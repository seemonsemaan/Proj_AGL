...
namespace Proj_AGL.Controllers
{
    ...
    public class AdminLocationsController : Controller
    {
        ...
        public AdminLocationsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PositionX,PositionY")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PositionX,PositionY")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
